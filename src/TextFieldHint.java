...
public class TextFieldHint implements FocusListener, DocumentListener, PropertyChangeListener
{
    ...
    public TextFieldHint(final JTextComponent textComp, String ghostText)
    {
        super();
